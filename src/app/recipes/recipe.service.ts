...
export class RecipeService {
  ...
  storeData() {
    ...
    return this.http.put('https://recipebook-905eb.firebaseio.com/recipes.json', body, {headers: headers});
  }

  fetchData() {
    return this.http.get('https://recipebook-905eb.firebaseio.com/recipes.json')
